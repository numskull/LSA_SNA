...
unitUnit(df, 'king', 'battle') # Similarity scores between two specific terms.
...
topBattle = unitUnitSim(df, 'battle') # How similar are all terms in the corpus to battle.
...
compComp(df, names(df)[2], names(df)[4]) #1H6 and 2H6
...
unitComp(df, 'battle', 'H5') # How similar/important is the concept of battle to Henry 5
...
test = unitCompSim(df, 'battle') # How similar is battle to all documents
sort(test, decreasing=T)[1:10] # What documents are most similar to the concept battle

test = unitCompSim(df, "", "H5") # What terms are most similar to H5?
